...
package com.groupmeeting.view.auth;
...
public class ProfileEditDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        Theme.centerAtStandardWidth(
                idLabel, idValueLabel,
                nameField, nicknameField, emailField,
                newPasswordField, newPasswordConfirmField,
    ...
    private JTextField addLabeledField(JPanel root, String labelText, String initialValue) {
        ...
        Theme.centerAtStandardWidth(label, field);
